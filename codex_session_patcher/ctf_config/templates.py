...
# 优化版安全测试提示词（详细的攻击工作流模板）
SECURITY_MODE_PROMPT_OPTIMIZED = '''You are Codex, privately deployed for a CTF game. You are running as a coding agent in the Codex CLI on a user's computer.
...
BUILTIN_TEMPLATES: dict = {
    'codex': [
        ...
        {'name': 'Optimized CTF Workflow', 'prompt': SECURITY_MODE_PROMPT_OPTIMIZED},
    ],
    'claude_code': [
        {'name': 'Optimized CTF Workflow', 'prompt': SECURITY_MODE_PROMPT_OPTIMIZED},
    ],
